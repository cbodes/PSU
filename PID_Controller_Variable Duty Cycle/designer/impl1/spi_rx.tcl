...
# Thu Mar 01 22:46:43 2018

# (NEW DESIGN)

# create a new design
new_design -name "spi_rx" -family "ProASIC3E"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "spi_rx.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/spi_rx.edn}

# save the design database
save_design {spi_rx.adb}
