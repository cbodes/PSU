...
# Thu Mar 01 22:45:07 2018

# (NEW DESIGN)

# create a new design
new_design -name "PID_ControllerSD" -family "ProASIC3E"
...
set_defvar "BA_NAME" "PID_ControllerSD_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "PID_ControllerSD.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/PID_ControllerSD.edn}

# save the design database
save_design {PID_ControllerSD.adb}


compile
report -type "status" {PID_ControllerSD_compile_report.txt}
report -type "pin" -listby "name" {PID_ControllerSD_report_pin_byname.txt}
report -type "pin" -listby "number" {PID_ControllerSD_report_pin_bynumber.txt}
